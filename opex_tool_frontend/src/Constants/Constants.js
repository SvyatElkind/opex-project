...
export { ERROR_MESSAGES, ALERT_MESSAGES, COMMON_ACTION_UI, COMMON_UI, TOAST_CONFIG, UI_CONFIG, HELP_UI, HELP_PICKER_UI, APP_VERSION_UI } from './uiStrings/commonUI';
